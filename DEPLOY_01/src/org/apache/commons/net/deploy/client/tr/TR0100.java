 ...
 *
 */
public class TR0100 extends Thread {

	private static boolean flag = true;

	private static final Logger log = Logger.getLogger(TR0100.class);
	...
	public TR0100() throws Exception {
		...
		if (flag) {
			...
			try {
				...
				if (flag) {
					...
					body = String.format("%s;%s","RUN_TR0101", ParamMap.getInstance().get("tain.deploy.time")).getBytes("EUC-KR");
					bodyLen = body.length;
